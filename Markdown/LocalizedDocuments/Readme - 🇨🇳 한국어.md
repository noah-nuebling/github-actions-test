...
Mac Mouse Fix is available in English, German and the languages listed in the [Acknowledgements](<../../Markdown/LocalizedDocuments/Acknowledgements - 🇨🇳 한국어.md>)
...
Mac Mouse Fix wouldn't be the same without these [awesome contributions](<../../Markdown/LocalizedDocuments/Acknowledgements - 🇨🇳 한국어.md>)
