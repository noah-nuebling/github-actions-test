...
def main():
    ...
    for language_dict in language_dicts:
        ...
        # Add comment to the top of the document which says that it is autogenerated and to change the template instead
        template = "<!-- THIS FILE IS AUTOMATICALLY GENERATED. DO NOT EDIT IT DIRECTLY -->" + template
